import store, {PLAYER_CHOICE_UNPAUSED_ACTION, PLAYER_NAME_CHANGED_ACTION, GAME_STORY_PROGRESSED_ACTION} from '@/store'
...
const pickName = {
  ...
  execute: async function(formData) {
    ...
    await store.dispatch(GAME_STORY_PROGRESSED_ACTION)
